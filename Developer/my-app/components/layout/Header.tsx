...
const navItems = [
  ...
  { id: 'process', labelKey: 'process', href: '#process' },
      ...
      <div className="max-w-[1200px] mx-auto px-5 md:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          >
            ...
            <span className="text-accent-gold text-xs tracking-wider uppercase">
              {t('home')}
            </span>
          </a>
      ...
      >
        <nav className="flex flex-col p-5 space-y-4">
          ...
          <a
            href="#contact"
            onClick={(e) => { e.preventDefault(); scrollToSection('#contact') }}
            className="flex items-center justify-center gap-2 bg-accent-gold text-primary-dark px-5 py-3 rounded font-montserrat text-sm font-semibold uppercase tracking-wider mt-4"
          >
            <Phone className="w-4 h-4" />
            {t('cta')}
          </a>
